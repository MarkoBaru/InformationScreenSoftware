    ...
    <>
      ...
      >
        ...
        {t.contentType === 'Folder' && (
          <Link
            to={`/tiles/new?parentTileId=${t.id}&screenId=${screenId}&returnTo=/`}
      ...
      {open && screen && (
        <div className="overview-screen__body">
          <div className="tree-toolbar">
            ...
            <Link to={`/tiles/new?screenId=${screenSummary.id}&returnTo=/`} className="btn btn--small btn--primary" style={{ textDecoration: 'none' }}>+ Neuer Inhalt</Link>
